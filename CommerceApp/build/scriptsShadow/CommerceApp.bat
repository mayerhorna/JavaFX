...
set CLASSPATH=%APP_HOME%\lib\CommerceApp-all.jar

@rem Execute CommerceApp
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %COMMERCE_APP_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%COMMERCE_APP_EXIT_CONSOLE%" exit 1
exit /b 1
